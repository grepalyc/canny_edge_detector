...
const unsigned char sobel_kernel_x[SOBEL_KERNEL_SIZE * SOBEL_KERNEL_SIZE] = { 1, 2, 1,
									      0, 0, 0,
									     -1,-2,-1 };
const unsigned char sobel_kernel_y[SOBEL_KERNEL_SIZE * SOBEL_KERNEL_SIZE] = { 1,  0, -1,
									      2,  0, -2,
									      1,  0, -1 };
